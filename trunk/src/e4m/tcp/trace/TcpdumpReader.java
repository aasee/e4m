...
/*
     \15:43:59.148363 IP 127.0.0.1.49579 > 127.0.0.2.23: S 1730357317:1730357317(0) win 24820 <nop,nop,sackOK,mss 1460>
...
public class TcpdumpReader extends BufferedReader {
  ...
  public TcpdumpPacket readPacket() throws IOException {
    String hdr = readLine();
  ...
  class Packet implements TcpdumpPacket {
    Packet(TcpdumpRecord r) { this.r = r; }
    TcpdumpRecord r;
    ...
    public int datalength() { return (r.data != null) ? r.data.length : 0; }
  }
