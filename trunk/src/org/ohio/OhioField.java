 ...
 *  A field includes both data and attributes describing the field.
 *  The <code>OhioField</code> class encapsulates a virtual screen field and
 *  provides methods for accessing and manipulating field attributes and data.
 *<p>
 *  <code>OhioField</code> objects can be accessed only through the
 *  <code>OhioFields</code> object.
 */
public interface OhioField {

  /**
   *  The starting position of the field.
   *  The position can range from 1 to the size of the virtual screen.
   *  The starting position of a field is the position of
   ...
   *  The position can range from 1 to the size of the virtual screen.
   *  The ending position of a field is the position of
   ...
   *  True if the field is pen-selectable, otherwise false.
   */
  public boolean isPenSelectable();
 
  /**
   *  Indicates whether or not the field is hidden.
   *  True if field is hidden, otherwise false.
   */
  public boolean isHidden();
 
  /**
   *  The text plane data for the field.
   *  This is similar to the <code>getData()</code> method using the
   *  <code>Ohio.Plane.TEXT</code> parameter, except the data is returned as
   ...
   *  When setting the String property, if the string is shorter than
   *  the length of the field, the rest of the field is cleared.
   *  If the string is longer than the field, the text is truncated.
   *  A subsequent call to this property will not reflect the changed text.
   *  To see the changed text, do a refresh on the <code>OhioFields</code>
   *  collection and retrieve a new <code>OhioField</code> object.
   *
   ...
   *
   *  @param
   *     targetPlane  An <code>Ohio.Plane</code> value indicating from which
