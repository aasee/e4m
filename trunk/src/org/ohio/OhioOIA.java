 ...
 *  This area is used to provide status information regarding
 *  the state of the host session and location of the cursor.
 *<p>
 *  An <code>OhioOIA</code> object can be obtained using the <code>getOIA()</code>
 *  method on an instance of <code>OhioScreen</code>.
 */
public interface OhioOIA {

  /**
   *  Indicates whether the field which contains the cursor is an alphanumeric field.
   ...
   *  If input is inhibited, <code>sendKeys()</code> or <code>sendAID()</code>
   *  calls to the <code>OhioScreen</code> are not allowed.
   *  Why input is inhibited can be determined from the value returned.
   *  If input is inhibited for more than one reason, the highest value is returned.
   */
  ...
  /**
   *  The communication check code.  If <code>getInputInhibitedType</code>
   *  returns <code>InputInhibited.COMMCHECK</code>,
   *  this property will return the communication check code.
   */
  public int getCommCheckCode();

  /**
   *  The machine check code.  If <code>getInputInhibitedType()</code>
   *  returns <code>InputInhibited.MACHINECHECK</code>,
   *  this property will return the machine check code.
   */
  public int getMachineCheckCode();

  /**
   *  The program check code.  If <code>getInputInhibitedType()</code>
   *  returns <code>InputInhibited.PROGCHECK</code>,
   *  this property will return the program check code.
   */
